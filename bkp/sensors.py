...
class Sensors:
    ...
    def getAllData(self):
        ...
        return { 
            "timestamp": time.time(),
            "accelerometer": [
                self.mpu_0x68.retryReturn(self.mpu_0x68.readAccelerometerMaster),
                self.mpu_0x68.retryReturn(self.mpu_0x68.readAccelerometerSlave),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readAccelerometerMaster),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readAccelerometerSlave),
            ], 
            "gyroscope": [
                self.mpu_0x68.retryReturn(self.mpu_0x68.readGyroscopeMaster),
                self.mpu_0x68.retryReturn(self.mpu_0x68.readGyroscopeSlave),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readGyroscopeMaster),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readGyroscopeSlave),
            ], 
            "magnetometer": [
                self.mpu_0x68.retryReturn(self.mpu_0x68.readMagnetometerMaster),
                self.mpu_0x68.retryReturn(self.mpu_0x68.readMagnetometerSlave),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readMagnetometerMaster),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readMagnetometerSlave),
            ],
            "temperature": [
                self.mpu_0x68.retryReturn(self.mpu_0x68.readTemperatureMaster),
                self.mpu_0x68.retryReturn(self.mpu_0x68.readTemperatureSlave),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readTemperatureMaster),
                self.mpu_0x69.retryReturn(self.mpu_0x69.readTemperatureSlave),
            ] 
        }
    ...
    def getCSVData(self, printData=False):
